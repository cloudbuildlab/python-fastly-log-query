...
def main():
    ...
    parser.add_argument(
        '--input-dir',
        type=str,
        default='./logs/srv_quakesearch-fastly/raw',
        help='Directory containing log files (default: ./logs/srv_quakesearch-fastly/raw)'
    )
    parser.add_argument(
        '--output',
        type=str,
        default='./logs/srv_quakesearch-fastly/parsed/parsed_logs.json',
        help='Output file path (default: ./logs/srv_quakesearch-fastly/parsed/parsed_logs.json)'
    )
    parser.add_argument(
        '--format',
        choices=['json', 'csv'],
